        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure you want to delete this category?')" href="{{URL::to('/delete-category/'.$category->category_id)}}" class="active styling-edit" ui-toggle-class="">
